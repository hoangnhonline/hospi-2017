<section id="ROOMS" style="background-color:#FFFFFF" style="position: relative;">
    <div style="background-color:#fff">
        ...
        <?php } ?>
        <div class="">
            <div class="block-rooms-rela col-sm-9">
                <?php if (!empty($rooms)) { ?>
                                ...
                                <div class="row-eq-height">
                                    ...
                                    <div class="col-md-4">
                                        <div class="ipull-right block-price">
                                            ...
                                            <p class="size13 grey" style="white-space: nowrap;"><strong><?php echo trans('070'); ?> <?php echo $modulelib->stay; ?> <?php echo trans('0122'); ?></strong></p>
                                            <?php } else { ?>
