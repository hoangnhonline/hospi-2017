                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <dl class="cb-img-name">
                                    <dt>
                                        <img src="<?php echo '../../'.PT_HOTELS_SLIDER_THUMBS_UPLOAD.$module->thumbnail_image; ?>" alt="<?php echo $module->hotel_title;?>" width="98">
                                    </dt>
                                    <dd>
                                        <h1><?php echo $module->hotel_title;?></h1>
                                        <div class="clearfix">
                                            <span class="go-right RTL"><i style="margin-left:-5px" class="icon-location-6"></i> <small class="adddress"><?php echo $module->hotel_map_city;?></small></span>
                                        </div>
                                        <div class="clearfix">
                                ...
                                <ul class="order-summary">
                                    ...
                                    <li>
                                        <div class="k">
                                            ...
                                            <?php echo number_format($priceOne); ?> x <?php echo $stay; ?> (đêm) x <?php echo $quantity; ?> (phòng) = <?php echo number_format($rDetail->Info['total']*$quantity); ?> VND
                                        </div>
                                    </li>
                                    <?php 
                                    ...
                                    <li style="border: none;">
                                        ...
                                        <strong class="v purple" id="tong_thanh_toan_span"><?php echo number_format($priceTotal + $priceExtraBedTotal); ?> VND</strong>
