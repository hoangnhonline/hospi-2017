            ...
            <div class="page-info-user">
                <form class="row block-panel-info" id="bookingdetails">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="firstname" placeholder="" name="lastname">
                                </div>
                                <div class="form-group col-md-6">
                                    <br>
                                    <div class="">
                                        ...
                                        <div class="showInput">
                                                <div style="border: 1px solid #ccc; padding: 10px 15px; margin: 10px 0;">
                                                    <div class="row form-group">
                                                        <div class="col-sm-8">
                                                            <input type="text" name="company" class="form-control" placeholder="Nhập tên công ty của bạn">
                                                        </div>
                                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="companyadd" class="form-control" placeholder="Địa chỉ">
                                                    </div>
                                                    <div class="clearfix">
                    ...
                    <div class="col-sm-5 col-xs-12">
                                ...
                                <ul class="order-summary">
                                    ...
                                    <li>
                                        <div class="k">
                                            ...
                                            <?php echo number_format($price); ?> x <?php echo $quantity; ?> = <?php echo number_format($priceTotal); ?> <?php echo $module->currSymbol; ?>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <?php if (!empty($module->surchargeInfo)) {
                                        foreach ($module->surchargeInfo as $item) {
                                            ...
                                            $price_surcharge = $squantity[$item->id] * $price_surcharge;
                                    ...
                                    <li>
                                        ...
                                        <strong class="v"><?php echo number_format($priceTotal + $priceSurchargeTotal); ?> VND</strong>
                                        <input type="hidden" name="tong_chua_giam" id="tong_chua_giam" value="<?php echo $priceTotal + $priceSurchargeTotal; ?>">
                                    </li>
                                    <li style="border: none;">
                                        ...
                                        <div class="v">
                                            <button style="margin-left:0; margin-bottom: 0; padding: 5px 16px;" type="button" class="btn btn-action btn-block chk applycoupon">ÁP DỤNG</button>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                    ...
                                    <li style="border: none;">
                                        ...
                                        <strong class="v purple" id="tong_thanh_toan_span"><?php echo number_format($priceTotal + $priceSurchargeTotal); ?> VND</strong>
                                        <input type="hidden" name="tong_thanh_toan" id="tong_thanh_toan" value="<?php echo ($priceTotal + $priceSurchargeTotal); ?>">
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <p class="text-center">
                            <button type="submit" class="btn btn-action2 completebook" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');">Hoàn Thành</button>
                        </p>
                    </div>
