<html lang="en">
  ...
  <div class="container">
    ...
    <!--<p class="text-center" style="color:#ccc"> Powered by  <a target="_blank" style="color: #FCFCFC" href="http://phptravels.com"><b>PHPTRAVELS</b></a> <a href="http://phptravels.com/change-log/#<?php echo PT_VERSION; ?>"></a><?php echo PT_VERSION; ?></p>-->
    <!-- END SIGNIN SECTION-->
