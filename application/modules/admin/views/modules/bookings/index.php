                        ...
                        if (!empty($content)) {
                            ...
                            foreach ($content as $item) {
                                ...
                                <tr id="row-<?php echo $item->booking_id; ?>">
                                    ...
                                    <td><?php echo $item->booking_ref_no; ?></td>          
                                    <td><?php echo $item->ai_last_name; ?></td>
                                    <td><?php echo $item->booking_type == "hotels" ? "Khách sạn" : $item->booking_type; ?></td>
                                    <td class="text-center"><?php echo date('d/m/Y', $item->booking_date); ?></td>
                                    <td class="text-right"><?php echo number_format($item->booking_total); ?></td>
                                    <td class="text-right"><?php echo number_format($item->booking_amount_paid); ?></td>
                                    <td>
                                        <?php
