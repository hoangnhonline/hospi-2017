...
<html ng-app="phptravelsApp">
  <head>
   ...
   <!--<link href="<?php echo $theme_url; ?>assets/css/bootstrap-modal.css" rel="stylesheet" media="screen">-->
    ...
    <!-- BASE CSS ---------> <link href="<?php echo $theme_url; ?>style.css" rel="stylesheet"> <style> @import "<?php echo $theme_url; ?>childtheme/childstyle.css"; </style>
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right go-left top-menu">
                ...
                <?php } ?>
                  <?php if(!$ishome) { ?>
                       ...
                       <div class="col-md-4 blog-items header-quantam">
                            <div class="form-group"> <h3 class="main-title go-right andes-bold"><?php echo trans('0583'); ?></h3><div class="clearfix"></div></div>
                            <div class="row col-md-12"><a href="<?php echo base_url();?>offers/sales"><div class="header-khuyenmai-gray"><?php echo trans('0558'); ?></div></a>
                                <a href="<?php echo base_url();?>offers/bestchoice"><div class="header-bestchoice-gray"><?php echo trans('0559'); ?></div></a>
                                <a href="<?php echo base_url();?>offers"><div class="header-deals-gray"><?php echo trans('0580'); ?></div></a>
                            </div>
                    ...
                    <div class="form-group"> <h3 class="main-title go-right andes-bold"><?php echo trans('0582'); ?></h3><div class="clearfix"></div></div>
                    ...
                    <span class="<?php echo $pagesinfo->page_slug;?>">
                       <div class="col-md-4 blog-items header-quantam">
                           <div class="header-offer-content">
                            <div class="form-group"> <h2 class="main-title go-right andes-bold"><?php echo trans('0558'); ?></h2><div class="clearfix"></div></div>
                            <?php echo trans('0588'); ?>
                            </div>
                            <div class="clearfix"></div>
                    <div align="center">
                    <a class="noikhac" href="<?php echo base_url()?>offers/sales"><?php echo trans('0564'); ?><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                        ...
                        <div class="col-md-8 blog-items">
                            ...
                            <div class="place-row">
                                <div class="place-cell"><h3 class="main-title go-right andes-bold"><?php echo trans('0589'); ?></h2></div>
                                <div class="place-cell"><h3 class="main-title go-right andes-bold"><?php echo trans('0590'); ?></h2></div>
                                <div class="place-cell"><h3 class="main-title go-right andes-bold"><?php echo trans('0591'); ?></h2></div>
                            </div>
                            <?php $i=0; foreach ($salesoffHotels as $topsale) { ?>
                                <div class="place-row childrow">
                                    <div class="place-cell"><a href="<?php echo $topsale->slug;?>" style="text-transform: none;"><?php echo $topsale->title; ?></a><?php echo $topsale->stars; ?>
                    ...
                    <span class="<?php echo $pagesinfo->page_slug;?>">
                        ...
                        <?php $i=0; foreach($posts as $post){
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                            <div class="form-group"> <h3 class="main-title go-right andes-bold"><?php echo $post->post_title;?></h3><div class="clearfix"></div></div>
              ...
              <div class="quick-menu">
                <div id="checkbooking" class="dropdown"><a class="go-right dropdown-toggle" data-toggle="dropdown" href="#" ><i class="fa fa-ellipsis-h" aria-hidden="true"></i></a>
                  ...
                  <div class="check-booking dropdown-menu">
                    ...
                    </li><?php  if(!empty($customerloggedin)){ ?>
