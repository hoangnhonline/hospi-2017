...
// add review by customer
		function add_review_cust($status) {
				$data = array('review_booking_id' => $this->input->post('bookingid'), 
					...
					'review_date' => time(), 
					'review_clean' => $this->input->post('reviews_clean'), 'review_anuong' => $this->input->post('reviews_anuong'), 
...
// add review by public
		function add_review_public($status) {
				$data = array('review_name' => $this->input->post('fullname'), 'review_comment' => $this->input->post('reviews_comments'), 'review_module' => $this->input->post('reviewmodule'), 'review_itemid' => $this->input->post('reviewfor'), 'review_date' => time(), 'review_clean' => $this->input->post('reviews_clean'), 'review_staff' => $this->input->post('reviews_staff'), 'review_anuong' => $this->input->post('reviews_anuong'), 'review_facilities' => $this->input->post('reviews_facilities'), 'review_location' => $this->input->post('reviews_location'), 'review_comfort' => $this->input->post('reviews_comfort'), 'review_overall' => $this->input->post('overall'), 'review_email' => $this->input->post('email'), 'review_status' => $status);
				$this->db->insert('pt_reviews', $data);
		}
